...
RUN apt-get -y install nginx-extras php5-cli php5-curl php5-fpm php5-json php5-mcrypt php5-mysql php5-sqlite php5-xmlrpc php5-xsl php-apc curl git unzip supervisor mysql-server mysql-client ; \
 apt-get clean
