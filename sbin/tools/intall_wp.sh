...
sudo -u user_app -- wp core download --path=/data/www
...
sudo -u user_app -- wp core language install zh_CN --path=/data/www

sudo -u user_app -- wp core language activate zh_CN --path=/data/www
